...
package com.qst.fly.widget.view;
...
public class PLA_ListView extends PLA_AbsListView {
	...
	public int getAbsFirstVisiblePosition() {
	...
	private View fillSpecific(int position, int top) {
			...
			if (!mStackFromBottom) {
				...
				// This will correct for the top of the first view not touching
				// the top of the list
				adjustViewsUpOrDown();
				...
				// This will correct for the bottom of the last view not
				// touching the bottom of the list
				adjustViewsUpOrDown();
				fillUp(position - 1, getFillChildTop());
				int childCount = getChildCount();
				if (childCount > 0) {
